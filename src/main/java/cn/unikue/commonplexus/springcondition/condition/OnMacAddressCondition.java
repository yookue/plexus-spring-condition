...
import cn.unikue.commonplexus.springcondition.annotation.ConditionalOnMacAddress;
import cn.unikue.commonplexus.springcondition.util.ConditionBecauseUtils;
import cn.unikue.commonplexus.springcondition.util.ConditionMacAddressUtils;
...
public class OnMacAddressCondition extends SpringBootCondition {
    ...
    public ConditionOutcome getMatchOutcome(@Nonnull ConditionContext context, @Nonnull AnnotatedTypeMetadata metadata) {
        ...
        return ConditionMacAddressUtils.matchMacAddress(annotation, "address", address, regex);    // $NON-NLS-1$
    }
}
