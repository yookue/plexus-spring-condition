...
import cn.unikue.commonplexus.javaseutil.util.SystemUtilsWraps;
...
/**
 * Condition being active when missing all the system environment variables
 *
 * @author David Hsing
 */
@Order(value = Ordered.LOWEST_PRECEDENCE - 1000)
@SuppressWarnings("unused")
public class OnMissingEnvironmentCondition extends SpringBootCondition {
