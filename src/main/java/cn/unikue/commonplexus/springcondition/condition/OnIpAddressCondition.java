...
import cn.unikue.commonplexus.springcondition.annotation.ConditionalOnIpAddress;
import cn.unikue.commonplexus.springcondition.util.ConditionBecauseUtils;
import cn.unikue.commonplexus.springcondition.util.ConditionIpAddressUtils;


/**
 * Condition being active when matching the ip address
 *
 * @author David Hsing
 */
@Order(value = Ordered.LOWEST_PRECEDENCE - 1000)
@SuppressWarnings("unused")
public class OnIpAddressCondition extends SpringBootCondition {
    private static final Class<? extends Annotation> annotation = ConditionalOnIpAddress.class;
