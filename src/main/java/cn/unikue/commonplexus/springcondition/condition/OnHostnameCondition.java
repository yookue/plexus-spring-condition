...
import cn.unikue.commonplexus.springcondition.annotation.ConditionalOnHostname;
import cn.unikue.commonplexus.springcondition.util.ConditionBecauseUtils;
import cn.unikue.commonplexus.springcondition.util.ConditionHostnameUtils;


/**
 * Condition being active when matching the hostname
 *
 * @author David Hsing
 */
@Order(value = Ordered.LOWEST_PRECEDENCE - 1000)
@SuppressWarnings("unused")
public class OnHostnameCondition extends SpringBootCondition {
    private static final Class<? extends Annotation> annotation = ConditionalOnHostname.class;
