...
import cn.unikue.commonplexus.springcondition.condition.OnHostnameCondition;


/**
 * Annotation being active when matching the hostname
 *
 * @author David Hsing
 */
...
@Documented
@Conditional(value = OnHostnameCondition.class)
@SuppressWarnings("unused")
public @interface ConditionalOnHostname {
    /**
