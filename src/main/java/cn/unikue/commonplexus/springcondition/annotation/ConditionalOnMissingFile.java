...
import cn.unikue.commonplexus.springcondition.condition.OnMissingFileCondition;


/**
 * Annotation being active when missing the file or directory
 *
 * @author David Hsing
 */
...
@Documented
@Conditional(value = OnMissingFileCondition.class)
@SuppressWarnings("unused")
public @interface ConditionalOnMissingFile {
    /**
