...
import cn.unikue.commonplexus.springcondition.condition.OnLibraryCondition;


/**
 * Annotation being active when matching the loaded library name in the classpath
 *
 * @author David Hsing
 */
...
@Documented
@Conditional(value = OnLibraryCondition.class)
@SuppressWarnings("unused")
public @interface ConditionalOnLibrary {
    /**
