...
import com.yookue.commonplexus.springcondition.annotation.ConditionalOnHostname;
...
public class OnHostnameCondition extends SpringBootCondition {
    ...
    public ConditionOutcome getMatchOutcome(@Nonnull ConditionContext context, @Nonnull AnnotatedTypeMetadata metadata) {
        ...
        String hostname = attributes.getString("name");    // $NON-NLS-1$
        ...
        return ConditionHostnameUtils.matchHostname(annotation, "name", hostname, caseSensitive, regExp);    // $NON-NLS-1$
    }
}
